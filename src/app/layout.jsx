...
export const metadata = { 
  ...
  author: "Zimtech Engineering",
  og: {
    title: "Zimtech Engineering | Industrial Automation & Engineering Solutions",
    description:
      "At Zimtech Engineering, we offer top-tier industrial automation and engineering services to enhance manufacturing processes, improve efficiency, and deliver state-of-the-art control systems. Explore our expertise in automation.",
    type: "website",
    url: "https://www.zimtechengineering.co.zw",  // Replace with actual URL
    image: "/assets/1.png", // Ensure this image exists
  },
  canonical: "https://www.zimtechengineering.co.zw",  // Replace with actual URL

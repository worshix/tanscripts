...
export default function TrainingCard(prop){
    ...
    return(
        <>
        <div className="training-card w-[300px] bg-white bg-opacity-15 overflow-hidden isolate rounded-xl pb-2 card-container flex-shrink-0 mx-auto sm:mx-0 shadow-md shadow-black slide-in-bottom" id={id}>

...
export default function TrainingCard(prop){
    ...
    return(
        <>
        <div className="training-card w-[300px] bg-white bg-opacity-15 overflow-hidden isolate rounded-xl pb-2 card-container flex-shrink-0 mx-auto sm:mx-0 shadow-md shadow-black" id={id}>
            ...
            <Link className="block w-fit grad p-2 my-4 rounded-full font-bold m-2 mb-auto" href='/Contacts'>Begin Training</Link>

  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-end gap-3">
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-all duration-300 overflow-hidden"
      ...
      >
        ...
        {/* Hover ring - contained within button bounds */}
        <span className="absolute inset-1 rounded-full border-2 border-green-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </a>
    </div>
  );
}
